...
function makeCharacterDescription(character, race, occupation, xp) {
    ...
    return character + ' is ' + an + ' <u>' + level + '</u> <u>' + race + '</u> <u>' + occupation + '</u> with <u>' + xp + '</u> experience points.';
};
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
function identification(name, myJ) {
    ...
    x += '&nbsp';
    x += makeModal(name + "-backstory", characterName + "'s Backstory", "btn-default", "xs", myJ["id"]["name"] + "'s Backstory", myJ["id"]["backstory"]);
    x += '</p>'
